...
alter table nhanvien add Gioitinh nvarchar(50);
go
...
alter table khoahoc alter column GhiChu nvarchar(50) null 
go
...
END
go
-- Report: TEN_CD - SO_HV - THAP_NHAT - CAO_NHAT - TRUNG_BINH
...
--SELECT * FROM NhanVien
--SELECT * FROM NhanVien where MaVN = ?
...
go
insert into nguoihoc (MaNH, HoTen, NgaySinh, GioiTinh, DienThoai, Email, GhiChu, MaNV, NgayDK) VALUES 
('PS0001',N'Trần Nguyên Khang','9-15-2002',1,'0327987340','trannguyenkhang273@gmail.com',N'0327987340 - TRẦN NGUYÊN KHANG','LongNDH','10-9-2021')
go
insert into nguoihoc (MaNH, HoTen, NgaySinh, GioiTinh, DienThoai, Email, GhiChu, MaNV, NgayDK) VALUES 
('PS0002',N'Nguyễn Văn A','5-22-1999',1,'0123456789','Nguyenvana@gmail.com',N'0123456789 - NGUYỄN VĂN A','LongNDH','10-9-2021'),
('PS0003',N'Trần Tấn Đạt','12-01-2001',1,'0123654789','trantatdat@gmail.com',N'0123654789 - TRẦN TẤN ĐẠT','LongNDH','12-7-2020'),
('PS0004',N'Nguyễn Lan Hương','9-25-2002',0,'0987654321','nguyenlanhuong@gmail.com',N'0987654321 - NGUYỄN LAN HƯƠNG','NghiemN','10-9-2019'),
('PS0005',N'Nguyễn Thị Nỡ','9-15-2002',0,'0789654321','nguyenthino@gmail.com',N'0789654321 - NGUYỄN THỊ NỠ','PheoNC','5-22-2018'),
('PS0006',N'Trần Văn Thành','9-26-2002',1,'0987546123','nguyenvanthanh@gmail.com',N'0987546123 - TRẦN VĂN THÀNH','ThaoLTH','12-5-2018'),
('PS0007',N'Nguyễn Văn Tuấn','5-15-2000',1,'0987123645','nguyenvantuan@gmail.com',N'0987123645 - NGUYỄN VĂN TUẤN','PheoNC','2-16-2021');
go
